...
from algs.lz78 import coding, decoding as decoding_lz, save_compressed as save_compressed_file_lz, load_compressed as load_compressed_file_lz
from algs.huffman import HuffmanCode, decoding, save_compressed_file, load_compressed_file
...
for f in os.listdir("data/compressing_test_data"):
    file_path = os.path.join("data/compressing_test_data", f)
    print(f)
    print('Huffman')
    start_time = time()
